...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    strUrl = [track objectForKey:@"artwork_url"];
    
    NSLog(@"STR : %@", strUrl);
    
    if (![strUrl isKindOfClass:[NSNull class]]){
        NSURL* url = [NSURL URLWithString:strUrl];
        [cell.imageView setImageWithURL:url placeholderImage:[UIImage imageNamed:@"logo_rh.png"]];
    }else{
        [cell.imageView setImage:[UIImage imageNamed:@"logo_rh.png"]];
    }
